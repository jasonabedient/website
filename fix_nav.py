...
files_videos = ['videos/index.html']
...
nav_template = """            <nav class="main-nav">
                ...
                <a href="{href_videos}"{cls_videos}>Videos</a>
...
def replace_nav(file_path, depth_type, active_file_name_if_any=None):
    if depth_type == 'root':
        ...
        href_videos = 'index.html' if depth_type == 'videos' else '../videos/index.html'
        href_contact = '../contact.html'
    ...
    cls_videos = ' class="active"' if active_file_name_if_any == 'videos' else ''
    ...
    new_nav = nav_template.format(
        ...
        href_videos=href_videos, cls_videos=cls_videos,
...
for f in files_videos:
    replace_nav(f, 'videos', 'videos')
